...
words = "\x1b[6;30;42m[CLONER ECHO POR X A V I]\x1b[0m\nHOLA\nSOPORTE: NO HAY APAÑATE GAY\n"
for char in words:
    sleep(0.1)
...
def main():
    ...
    while stats:
        ...
        elif command.startswith(".roles") or command.startswith(".copy -r"):
        ...
        # just copy emojis
        elif command.startswith(".emojis") or command.startswith(".copy -e"):
            guild_id = input("Give me server id: ")
            guild = Guild(guild_id, token)
        ...
        elif command.startswith(".settings") or command.startswith(".copy -s"):
            guild_id = input("Give me server id: ")
            guild = Guild(guild_id, token)
        ...
        elif command.startswith(".all") or command.startswith(".copy -a"):
